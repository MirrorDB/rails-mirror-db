...
require 'mirror_reflection/version'

Gem::Specification.new do |spec|
  spec.name          = "mirror_reflection"
  spec.version       = MirrorReflection::VERSION
  spec.authors       = ["Ilton Garcia dos Santos Silveira"]
  spec.email         = ["ilton_unb@hotmail.com"]
  spec.summary       = 'MirrorReflectionFramework to easy migrate to or create a Rails projects'
  spec.description   = 'MirrorReflection generate a mirror application based on the existing DataBase'
  spec.homepage      = "http://mirrorreflection.github.io/rails_mirror_reflection"
  spec.license       = "MIT"
